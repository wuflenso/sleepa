...
class FollowersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follower" do
    assert_difference("Follower.count") do
      post followers_url, params: { follower: { followed_at: @follower.followed_at, follower_user_id: @follower.follower_user_id, is_active: @follower.is_active, user_id: @follower.user_id } }, as: :json
    end
  ...
  test "should update follower" do
    patch follower_url(@follower), params: { follower: { followed_at: @follower.followed_at, follower_user_id: @follower.follower_user_id, is_active: @follower.is_active, user_id: @follower.user_id } }, as: :json
    assert_response :success
  end
